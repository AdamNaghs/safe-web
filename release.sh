...
if [ -z "$VERSION" ]; then
    ...
    echo "Example: ./release.sh 1.0.6 'Fixed bug in fetch command'"
    exit 1
fi
...
# Stage ONLY the files in this skill folder
echo "📋 Staging changes..."
git add README.md SKILL.md skill.json scripts/
...
git push safe-web main
git push safe-web "v$VERSION"
